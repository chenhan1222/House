...
<div class="panel admin-panel" style="width: 80%;margin: 0 auto;margin-top: 20px">
    <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>管理员登录</strong></div>
    <div class="body-content">
        <form method="post" class="form-x" action="adminLogin">
            <div class="form-group">
                <div class="label">
                    <label>账号：</label>
                </div>
                <div class="field">
                    <input type="text" class="input" value="" name="aname"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="password" class="input" value="" name="apass"/>
                    <div class="tips"></div>
                </div>
            </div>
